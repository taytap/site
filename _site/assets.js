...
function Filter(list) {
    ...
    var input = $('<input>').attr({ 'type':'text', 'placeholder':'Filtrar por palavra' });
...
var show = $('<a class=\'control show\'>Mostrar tudo</a>');
show.click(function () {
  $('#content article:not(".active") > a').trigger('click');    
});
$('#content').prepend(show);

var hide = $('<a class=\'control hide\'>Esconder tudo</a>');
hide.click(function () {
